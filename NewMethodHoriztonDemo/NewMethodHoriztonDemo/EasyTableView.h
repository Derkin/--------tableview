...
@interface EasyTableView : UITableViewCell <UITableViewDelegate, UITableViewDataSource> {
@private
...
- (id)initWithStyle:(UITableViewCellStyle)style Frame:(CGRect)frame numberOfColumns:(NSUInteger)numCols ofWidth:(CGFloat)width reuseIdentifier:(NSString *)reuseIdentifier;
